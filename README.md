...
- [caffeineMoment - Introduction](#caffeinemoment---introduction)
  - [User Experience - UK](#user-experience---ux)
    ...
    - [Features](#features)
      ...
      - [Product shopping Bag](#products-shopping-bag)
      - [Product Checkout](#products-checkout)
      - [Product Managemnet](#products-management)
      - [Profile Page](#profile-page)
      - [Add Edit Service Review Page](#addedit-service-review-page)
      - [Login Pages](#logins-pages)
      ...
      - [Admin panel](#admin-panel--superuser)
      - [Marketing and Social Media](#marketing-and-social-media)
        ...
        - [AWS Setup Process](#aws-setup-process)
          ...
          - [Testing](#testing)
          - [create Django App](#creating-the-django-app)
          - [Cloning this proje](#cloning-this-project)
